...
var CountryFlagsSelect = function (_Component) {
  _inherits(CountryFlagsSelect, _Component);

  function CountryFlagsSelect(props) {
    _classCallCheck(this, CountryFlagsSelect);
  ...
  CountryFlagsSelect.prototype.toggleOptions = function toggleOptions() {
    !this.state.disabled && this.setState({
      openOptions: !this.state.openOptions
    });
  };

  CountryFlagsSelect.prototype.closeOptions = function closeOptions(event) {
  ...
  CountryFlagsSelect.prototype.onSelect = function onSelect(countryCode) {
    this.setState({
  ...
  CountryFlagsSelect.prototype.updateSelected = function updateSelected(countryCode) {
  ...
  CountryFlagsSelect.prototype.filterSearch = function filterSearch(evt) {
    var _this2 = this;
  ...
  CountryFlagsSelect.prototype.componentDidMount = function componentDidMount() {
    !this.props.disabled && window.addEventListener("click", this.closeOptions);
  };

  CountryFlagsSelect.prototype.componentWillUnmount = function componentWillUnmount() {
    !this.props.disabled && window.removeEventListener("click", this.closeOptions);
  };

  CountryFlagsSelect.prototype.render = function render() {
    var _this3 = this;
...
exports.default = CountryFlagsSelect;
